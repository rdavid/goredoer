...
:img-license: https://img.shields.io/github/license/rdavid/goredoer?color=94bff3&labelColor=555555&logo=data%3Aimage%2Fsvg%2Bxml%3Bbase64%2CPHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%2BPHRleHQgeD0iMTIiIHk9IjIwIiBmb250LWZhbWlseT0iSGVsdmV0aWNhLEFyaWFsLHNhbnMtc2VyaWYiIGZvbnQtc2l6ZT0iMjgiIHRleHQtYW5jaG9yPSJtaWRkbGUiIGZpbGw9IiNkY2RjY2MiPiYjMTY5OzwvdGV4dD48L3N2Zz4%3D&style=flat
:img-publish: https://img.shields.io/github/actions/workflow/status/rdavid/goredoer/publish.yml?color=8cd0d3&label=publish&labelColor=555555&logo=docker&logoColor=dcdccc&style=flat
:img-releases: https://img.shields.io/github/v/release/rdavid/goredoer?color=f0dfaf&label=%20&labelColor=555555&logo=semver&logoColor=dcdccc&style=flat
:img-test: https://img.shields.io/github/actions/workflow/status/rdavid/goredoer/test.yml?branch=master&color=7f9f7f&label=test&labelColor=555555&logo=github&logoColor=dcdccc&style=flat
...
:url-hadolint: https://hadolint.github.io/hadolint/
...
[,sh]
----
COPY --from=ghcr.io/rdavid/goredoer:0.9.20260909 /goredo .
RUN goredo -symlinks
----
...
Install {url-goredo}[`goredo`] and {url-shellbase}[`shellbase`] to run the
tasks:
